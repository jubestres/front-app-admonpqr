<template>
  <layout-main>
    <template #slotLayout>
      <Header 
      :titulo="'Radicado PQR'" 
      :tituloBoton="'Crear Radicado PQR'" 
      :abrir="abrirFormulario" />
     


      <Formulario :titulo="'Gestion de radicado PQR'" v-model:is-Open="mostrarFormulario" :is-edit="editandoFormulario">

        <template #slotform>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <formradicadopqr v-model:is-open="mostrarFormulario":is-edit="editandoFormulario"/>
            </el-col>
          </el-row>
        </template>
