<template>
  <layout-main>
    <template #slotLayout>
      <Header 
      :titulo="'Proyectos'" 
      :tituloBoton="'Crear Proyectos'" 
      :abrir="abrirFormulario" />
     


      <Formulario :titulo="'Gestion de proyectos'" v-model:is-Open="mostrarFormulario" :is-edit="editandoFormulario">

        <template #slotform>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <formproyectos v-model:is-open="mostrarFormulario":is-edit="editandoFormulario"/>
            </el-col>
          </el-row>
        </template>
